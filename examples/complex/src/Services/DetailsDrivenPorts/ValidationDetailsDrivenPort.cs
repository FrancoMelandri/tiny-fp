...
public class ValidationDetailsDrivenPort(IDetailsDrivenPort detailsDrivenPort) : IDetailsDrivenPort
{
    ...
    public Task<Either<ApiError, ProductDetails>> GetDetailsAsync(string productName)
        => ValidateEmptyBlankOrNull(productName)
            ...
            .MatchAsync(_ => detailsDrivenPort.GetDetailsAsync(productName),
